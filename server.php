...
// Finally, register user if there are no errors in the form
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO users (fullname, username, number, email, location, password) 
  			  VALUES('$fullname','$username','$number', '$email','$location', '$password')";
...
if (isset($_POST['order_user'])) {
  ...
  if (empty($date)) { array_push($errors, "date is required"); }
    ...
    $query = "INSERT INTO users (username, coconut, vanilla, heart, date) 
